...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_personinfo_2eproto[2];
...
const uint32_t TableStruct_personinfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::first_example::Person, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::first_example::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::first_example::Person, name_),
  PROTOBUF_FIELD_OFFSET(::first_example::Person, id_),
  PROTOBUF_FIELD_OFFSET(::first_example::Person, email_),
  0,
  2,
  1,
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::first_example::AddressBook, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::first_example::AddressBook, people_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::first_example::Person)},
  { 12, -1, -1, sizeof(::first_example::AddressBook)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::first_example::_Person_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::first_example::_AddressBook_default_instance_),
};

const char descriptor_table_protodef_personinfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020personinfo.proto\022\rfirst_example\"Z\n\006Per"
  "son\022\021\n\004name\030\001 \001(\tH\000\210\001\001\022\017\n\002id\030\002 \001(\005H\001\210\001\001\022"
  "\022\n\005email\030\003 \001(\tH\002\210\001\001B\007\n\005_nameB\005\n\003_idB\010\n\006_"
  "email\"4\n\013AddressBook\022%\n\006people\030\001 \003(\0132\025.f"
  "irst_example.Personb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_personinfo_2eproto = {
  false, false, 187, descriptor_table_protodef_personinfo_2eproto, "personinfo.proto", 
  &descriptor_table_personinfo_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_personinfo_2eproto::offsets,
  file_level_metadata_personinfo_2eproto, file_level_enum_descriptors_personinfo_2eproto, file_level_service_descriptors_personinfo_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_personinfo_2eproto_getter() {
  return &descriptor_table_personinfo_2eproto;
}
...
Person::Person(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:first_example.Person)
}
Person::Person(const Person& from)
  ...
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:first_example.Person)
}
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:first_example.Person)
...
void Person::Clear() {
// @@protoc_insertion_point(message_clear_start:first_example.Person)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "first_example.Person.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "first_example.Person.email"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Person::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:first_example.Person)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:first_example.Person)
  return target;
}

size_t Person::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:first_example.Person)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:first_example.Person)
...
// @@protoc_insertion_point(class_specific_copy_from_start:first_example.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Person::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_personinfo_2eproto_getter, &descriptor_table_personinfo_2eproto_once,
      file_level_metadata_personinfo_2eproto[0]);
}
...
AddressBook::AddressBook(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:first_example.AddressBook)
}
AddressBook::AddressBook(const AddressBook& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      people_(from.people_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:first_example.AddressBook)
}
...
AddressBook::~AddressBook() {
  // @@protoc_insertion_point(destructor:first_example.AddressBook)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:first_example.AddressBook)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      // repeated .first_example.Person people = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr -= 1;
          do {
...
uint8_t* AddressBook::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:first_example.AddressBook)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:first_example.AddressBook)
  return target;
}

size_t AddressBook::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:first_example.AddressBook)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:first_example.AddressBook)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:first_example.AddressBook)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AddressBook::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_personinfo_2eproto_getter, &descriptor_table_personinfo_2eproto_once,
      file_level_metadata_personinfo_2eproto[1]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace first_example
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::first_example::Person* Arena::CreateMaybeMessage< ::first_example::Person >(Arena* arena) {
  return Arena::CreateMessageInternal< ::first_example::Person >(arena);
}
template<> PROTOBUF_NOINLINE ::first_example::AddressBook* Arena::CreateMaybeMessage< ::first_example::AddressBook >(Arena* arena) {
  return Arena::CreateMessageInternal< ::first_example::AddressBook >(arena);
}
