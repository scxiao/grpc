...
class PersonRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.PersonRequest) */ {
 public:
  inline PersonRequest() : PersonRequest(nullptr) {}
  ~PersonRequest() override;
  explicit constexpr PersonRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
// required string name = 1;
inline bool PersonRequest::_internal_has_name() const {
...
void PersonRequest::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
inline const std::string& PersonRequest::_internal_name() const {
  return name_.Get();
}
inline void PersonRequest::_internal_set_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PersonRequest::_internal_mutable_name() {
  _has_bits_[0] |= 0x00000001u;
